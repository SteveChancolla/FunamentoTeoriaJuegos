...
void MainGame::handleInput()
{
	...
	if (inputManager.isKeyPressed(SDLK_o)) {
		...
		_sprites.back()->init(randomX(randomEngine)*TILE_WIDTH, randomY(randomEngine)*TILE_WIDTH, _witdh / 2, _witdh / 2, "Textures/arthur.png");
	}
	...
	if (inputManager.isKeyPressed(SDLK_u)) {
		...
		_sprites.push_back(new Sprite());
		_sprites.back()->init(randomX(randomEngine)*TILE_WIDTH, randomY(randomEngine)*TILE_WIDTH, _witdh / 2, _witdh / 2, "Textures/Sanic.png");
	}
	if (inputManager.isKeyPressed(SDLK_p)) {
		...
		_sprites.push_back(new Sprite());
		_sprites.back()->init(randomX(randomEngine)*TILE_WIDTH, randomY(randomEngine)*TILE_WIDTH, _witdh / 2, _witdh / 2, "Textures/way.png");
	}
}
